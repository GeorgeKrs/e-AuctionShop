...
<div class="sideNav mt-4">
    <ul class="category-list">
        ...
        <li><b><a href="#" class="category-links">Κιθάρες</a></b></li>
        <li><b><a href="#" class="category-links">Μπάσο</a></b></li>
        <li><b><a href="#" class="category-links">Synthesizer</a></b></li>
        <li><b><a href="#" class="category-links">Πλήκτρα</a></b></li>
    </ul>
