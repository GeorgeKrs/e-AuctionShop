...
<!-- <div class="container-fluid "> -->
        ...
        <div class="row">
            ...
            <div class="mt-4" style="float: left;">
                <ul class="category-list">
                    ...
                    <li style="display: inline;"><a href="https://www.facebook.com/" target="_blank" class="footer-links"><i class="fab fa-facebook"></a></i></li>
                    <li style="display: inline; padding-left: 30px;"><a href="https://www.instagram.com/" target="_blank" class="footer-links"><i class="fab fa-instagram"></i></a></li>
                </ul>
            </div>
    ...
    <div class="container" id="siteName" style="color: #0275d8; ">
        <h6 style="font-family:Big Shoulders Display, cursive; float: right;">&copy; 2021 e-AuctionShop.gr</h6>
    </div>
